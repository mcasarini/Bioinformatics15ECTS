...
In parallel, **FOLH1** (folate hydrolase 1), which encodes the prostate-specific membrane antigen (PSMA), was investigated in PRAD. FOLH1 is clinically important because PSMA is widely used as a diagnostic imaging target and an emerging therapeutic target in prostate cancer. Furthermore, variation in FOLH1 expression has been associated with tumor heterogeneity, disease progression, and clinically relevant molecular subtypes.
